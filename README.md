...
**全能版：**[快手自动续火花脚本](.code/自动续火花/快手/快手自动续火花脚本.js)

**懒人版：**[快手懒人版文字教程](.document/Document-Lazy.md)

**开发版：**[快手自动续火花脚本-开发版](.code/自动续火花/快手/快手自动续火花脚本-开发版.js)

#### 抖音自动续火花

**全能版：**[抖音自动续火花脚本](.code/自动续火花/抖音/抖音自动续火花脚本.js)

**开发版：**[抖音自动续火花脚本-开发版](.code/自动续火花/抖音/抖音自动续火花脚本-开发版.js)
...
​	[autojs6-v6.7.0-arm64-v8a-62db1ff8.apk - 镜像](https://ghproxy.net/https://github.com/SuperMonster003/AutoJs6/releases/download/v6.7.0/autojs6-v6.7.0-arm64-v8a-62db1ff8.apk)
...
| 适配更多安卓设备 | 2025-09-12 | ✕          | ✕        | 懒得测试其他设备，目前只测试了手机，因为我也没平板           |
